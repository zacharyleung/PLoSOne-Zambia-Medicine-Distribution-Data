...
public class Inventory {
	...
	public Inventory(LinkedList<Drug> drugList) {
		this.drugList = drugList;
	}
	
	public Inventory(int quantity, int tExpiry) {
		this();
	 ...
	 */
	public void addDrugs(int quantity, int tExpiry) {
	 ...
	 * @param shipment
	 */
	public void addDrugs(Inventory shipment) {
		drugList.addAll(shipment.drugList);
	}
	 ...
	 * @return
	 */
	public Inventory getDrugs(long quantity) throws Exception {
